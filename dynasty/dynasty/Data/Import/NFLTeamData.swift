...
enum NFLTeamData {
    ...
    static let previews: [String: TeamPreview] = [
        ...
        "WAS": TeamPreview(difficulty: 3, situation: "Rising", ownerPatience: "Moderate", patienceSeasons: 3, marketDescription: "Rebuilding brand in a major market, moderate pressure", estimatedOVR: 73, estimatedCapSpace: 32, estimatedDraftPicks: 8, coachingBudget: 48, spendingWillingness: 50, lastSeasonWins: 12, lastSeasonLosses: 5, startingQBName: "J. Daniels", startingQBOverall: 82),

        // NFC North
        "CHI": TeamPreview(difficulty: 4, situation: "Rising", ownerPatience: "Demanding", patienceSeasons: 2, marketDescription: "Massive market, title-starved fan base growing impatient", estimatedOVR: 74, estimatedCapSpace: 35, estimatedDraftPicks: 8, coachingBudget: 48, spendingWillingness: 70, lastSeasonWins: 5, lastSeasonLosses: 12, startingQBName: "C. Williams", startingQBOverall: 74),
