...
Pushattu `775cae0` asti. **PÄIVITYS 2026-08-10: MEGARUN AJETTU — kohdat 1-4 ja 6 TEHTY (committoimatta työpuussa, ks. Megarun-osio alla). Jäljellä:**
1. **#97+#157 balanssiaalto** (75+-lattia sitoo molempia → rigin revalidointi) + #163-jälkiseuranta. **UUSI SYÖTE: career-portin 6.2a (R1 elite share ≥10%) istuu täsmälleen rajalla — 9.97/10.36/10.95% kolmessa ajossa, menee punaiselle ~1/3 ajoista; kuuluu tähän aaltoon (seedaa assertti tai nosta share irti lattiasta).**
2. **UUSI #175 (sim-QA:sta): hubin TEAM-kortti navigoi AINA Owner Relationsiin** — ikoni/otsikko/body, kolme tappia eri kohtiin, sama väärä kohde joka kerta. Samalla selvitys: Standings/Schedule eivät ole tavoitettavissa offseasonissa mistään (ei nav-itemiä, TEAM-kortti rikki) — onko pre-kickoff-piilotus tarkoitus?
3. **UUSI #176 kuolleen UI:n poistoaalto** (#169-agentin todistama lista, ~2546 riviä): UI/Contracts/FreeAgencyView.swift (1297 r — W1c ehti konvertoida sen turhaan; poista konversioineen), UI/News/EventAlertView.swift (383), UI/Staff/CoachRelationshipView.swift (325), UI/MainMenu/LombardiTrophyView.swift (175) + loput agentin listalta. Todiste per tiedosto ennen poistoa (vain oma #Preview viittaa).
4. **UUSI #177 katselmuksen LOW-kasa** (11 kpl, ei korjattu): FAWeeklyView'n käsintehdyt rivit → DSListRow; viikkopresserin owner-wiring puuttuu (standing-strip lupaa ownerin jota ei tule); OwnerBriefing käyttää kultaa 4. rooliin; playoff-herokortin "Missed the playoffs" pre-load-framessa; TradeNegotiationView'n result-kopio; staff-result-sheetin Continue-välähdys.
5. Vanhat: ~~#158~~, ~~#166~~ (tehty megarunissa W5a:ssa), #137-perhe done. **PÄIVITYS 2026-08-07 ilta: #158, #131, #133, #134, #135, #36 ja #174 tehty — committoitu `91f62a5`.**

## MEGARUN 2026-08-10 — koko jono balanssiaaltoon asti (workflow wf_110c624a, 68 agenttia; KOMMITTOIMATTA työpuussa, 70 tiedostoa +16193/−9817)
...
**PARKISSA (käyttäjän päätös 2026-08-10): #167 Legal-aalto 1** — pudotettu työjonosta kokonaan; tehdään vasta kun peli on valmis. HUOM: pakko landata ennen MITÄÄN ulkoista jakelua (myös TestFlight) — nykybuildi shippaa 32 oikeaa NFL-nimeä Generated-polulla. Sisältö ja todisteet: docs/APP_STORE_COMPLIANCE_AUDIT.md (32 nimeä NFLTeamData:an, 8 toimittajaa, bg_draft.jpg NFL-shield + 15 imagesetiä, ~150 stringiä, TARGETED_DEVICE_FAMILY, PrivacyInfo.xcprivacy, ITSAppUsesNonExemptEncryption, IP-juristin lead time).
