...
- **🟠 P1: Pelikirjatuntemus ylirankaisee** — fam100 vs fam33 ≈ 93 % (konveksi cliff; ilmeisesti CAPITON defensiivinen coverage-bust-termi ~500 päästettyä syöttöjaardia). **BUG-luokka (round 3:n cap puuttui def-puolelta) — korjaus-workflow ajossa** [M/S]: cap + matalan famin käyrän loivennus → tavoite ~70-80 %.
